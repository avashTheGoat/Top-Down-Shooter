...
public class EnemyIdleRandomPointInCircleChaseWhenPlayerVisibleOrAttacked : EnemyIdleStateLogicBaseSO
{
    ...
    [SerializeField] private float minWanderSpeedMultiplier;
    [SerializeField] private float maxWanderSpeedMultiplier;
    ...
    public override void DoUpdateLogic()
    {
        ...
        if (isDoneWandering)
        {
            ...
            while (!_successfulDestination && _attempts < _maxAttempts)
            {
                ...
                float _speedMultiplier = Random.Range(minWanderSpeedMultiplier, maxWanderSpeedMultiplier);
